...
class Toastr
{
    ...
    {
        return '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/ebook/toastr@' . $version . '/dist/css/ebook-toastr.min.css">';
    }
    ...
    {
        return '<script src="https://cdn.jsdelivr.net/gh/ebook/toastr@' . $version . '/dist/js/ebook-toastr.min.js"></script>';
    }
